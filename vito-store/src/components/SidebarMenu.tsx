    ...
    return (
        <>
            ...
            <div className={`fixed top-0 left-0 h-full w-80 bg-white z-[70] shadow-2xl flex flex-col transform transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                ...
                {/* Enlaces Principales */}
                <div className="flex-1 overflow-hidden py-4 px-6 flex flex-col justify-between">
                    <nav className="flex flex-col gap-4 pt-2">
                        <Link href="/" onClick={onClose} className="text-lg font-bold text-gray-800 hover:text-pink-600 transition-colors">
                            Inicio
                        </Link>
                        <Link href="/?category=Conjuntos" onClick={onClose} className="text-lg font-bold text-gray-800 hover:text-pink-600 transition-colors">
                            Conjuntos
                        </Link>
                        <Link href="/?category=Bikinis" onClick={onClose} className="text-lg font-bold text-gray-800 hover:text-pink-600 transition-colors">
                            Bikinis
                        </Link>
                        <Link href="#mayorista" onClick={onClose} className="text-lg font-bold text-gray-800 hover:text-pink-600 transition-colors">
                    ...
                    <div className="flex flex-col gap-4 pb-4">
                        <div className="w-full border-t border-gray-100 mb-1" />
                        <span className="text-xs uppercase tracking-widest text-gray-400 font-bold">Síguenos</span>
                        <a href="https://instagram.com/vitoo.store" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-sm font-medium text-gray-700 hover:text-pink-600 transition-colors">
                        ...
                        <a href="https://wa.me/5493794088240" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-sm font-medium text-gray-700 hover:text-green-600 transition-colors">
                            <svg className="w-5 h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
